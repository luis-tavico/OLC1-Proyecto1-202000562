...
public class Interface extends javax.swing.JFrame {
    ...
    private void btnEjecutarMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnEjecutarMousePressed
        ...
        if (this.analizadorActual.equals("StatPy")) {
            try {
                AnalyzerResult result = Utils.loadFile(contenido);
                this.ast = result.ast;
                ...
                if (!lexErrors.isEmpty() || !sintaxErrors.isEmpty()) {
                    ...
                    this.areaResultado.insert(Utils.translatePython(ast), 0);
                }
            } catch (Exception ex) {
            ...
            try {
                Lexical scanner = new Lexical(new java.io.StringReader(contenido));
