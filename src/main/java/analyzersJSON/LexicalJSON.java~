 ...
 * from the specification file <tt>src/main/java/analyzersJSON/LexicalJSON.jflex</tt>
 */
public class LexicalJSON implements java_cup.runtime.Scanner {
  ...
  private static final String ZZ_ACTION_PACKED_0 =
    ...
    "\1\6\1\7\1\10\1\11\1\2\6\0\1\12\2\13"+
    "\1\0\1\2\2\0\1\2";
   ...
   */
  public LexicalJSON(java.io.Reader in) {
  ...
  public java_cup.runtime.Symbol next_token() throws java.io.IOException {
    ...
    System.out.println("Error lexico en: " + yytext() + ", Linea: " + yyline + ", Columna: " + yychar);
          ...
          case 21: break;
          case 11: 
            { tokens.add(new Tokens(yytext(), "cadena", yyline, (int)yychar)); return new Symbol(sym.STRING, yyline, (int)yychar, yytext());
            } 
            // fall through
          case 22: break;
          default:
